...
public class TabletsSword extends BaseShopItem {
    ...
    private static final String name = ChatColor.RED + "Tablet's Sword"; 
    private static final String configName = "TABLETS_SWORD";
    private static final double price = 50;
    private static final String priceLore = ChatColor.GOLD + "50" + ChatColor.GREEN + " coins";
    private static final String description = ChatColor.GREEN + "Tablet's mighty sword.";
